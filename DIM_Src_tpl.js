var app = (function () {
    ...
    function initModelsFromData(data, labels, stats) {
        ...
        var mPurple = createPhongMaterial({kd: [0.36, .09, 0.28]});
        var mHotpink = createPhongMaterial({kd: [0.79, 0., .21]});
        var mOrange = createPhongMaterial({kd: [1., 0.34, 0.15]});
        var mCyan = createPhongMaterial({kd: [0., 1., 1.]});
        var mMagenta = createPhongMaterial({kd: [1., 0., 1.]});
        //var mWhite = createPhongMaterial({kd: [1., 1., 1.]});

        var materials = [mRed, mPurple, mHotpink, mOrange, mCyan, mMagenta];
